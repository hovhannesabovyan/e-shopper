 ...
 * the view file should be `views/site/message.php`. In this view file, the following variables are available:
 *
 * - `$name`: the error name
...
class ErrorAction extends Action
{
     ...
     * would be "error", and the corresponding view file would be "views/site/message.php".
     */
    public $view;
    /**
